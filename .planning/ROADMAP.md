...
**Plans:** 2 plans
Plans:
- [ ] 09-01-PLAN.md — Event infrastructure (DomainEvent base, concrete events, RabbitConfig, DomainEventListener, JSON schemas) + service wiring
...
| 9. RabbitMQ Events | v2.0 | 0/2 | Not started | - |
