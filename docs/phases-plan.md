...
Полноценный CRUD структуры вуза: пользователи, группы, семестры, предметы, привязки преподавателей, помощники старосты, домашние задания, пороги красной зоны. gRPC-сервер для внутренних вызовов. Redis-кэширование. RabbitMQ-события.
