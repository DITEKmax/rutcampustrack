...
function JournalCellComponent_Conditional_0_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance();
    \u0275\u0275textInterpolate(ctx_r0.cell.symbol);
  }
}
...
var JournalCellComponent = class _JournalCellComponent {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _JournalCellComponent, selectors: [["app-journal-cell"]], inputs: { cell: "cell" }, decls: 2, vars: 1, consts: [[3, "class"], [1, "text-[var(--color-pending)]"]], template: function JournalCellComponent_Template(rf, ctx) {
    if (rf & 1) {
      \u0275\u0275template(0, JournalCellComponent_Conditional_0_Template, 2, 4, "span", 0)(1, JournalCellComponent_Conditional_1_Template, 2, 0, "span", 1);
    }
    if (rf & 2) {
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(JournalCellComponent, { className: "JournalCellComponent", filePath: "src/app/features/teacher/journal/journal-cell/journal-cell.component.ts", lineNumber: 16 });
})();
...
//# sourceMappingURL=chunk-DBXS6FQQ.js.map
