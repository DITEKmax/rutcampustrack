...
var StudentApiService = class _StudentApiService {
   ...
   */
  submitExcuseWithFile(lessonIds, excuseType, comment, file) {
    ...
    return this.http.post("/api/attendance/excuses/with-file", form).pipe(catchError((err) => {
      if (err.status === 404)
        return of(void 0);
      return throwError(() => err);
    }));
  ...
  requestLateCheckin(lessonId) {
    return this.http.post(`/api/attendance/late-checkin/${lessonId}`, {});
  }
...
//# sourceMappingURL=chunk-ESVH3VU5.js.map
