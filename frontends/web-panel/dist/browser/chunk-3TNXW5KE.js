...
function StudentCheckinComponent_Conditional_6_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(21);
    \u0275\u0275elementEnd()();
    \u0275\u0275template(22, StudentCheckinComponent_Conditional_6_Conditional_22_Template, 2, 1, "p", 20);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    let tmp_3_0;
    const ctx_r0 = \u0275\u0275nextContext();
    const active_r3 = \u0275\u0275readContextLet(2);
    \u0275\u0275advance(6);
    \u0275\u0275textInterpolate1(" ", (tmp_3_0 = \u0275\u0275pipeBind1(7, 7, ctx_r0.getSubjectName$(active_r3.subjectId))) !== null && tmp_3_0 !== void 0 ? tmp_3_0 : "\u041F\u0440\u0435\u0434\u043C\u0435\u0442", " ");
    \u0275\u0275advance(5);
    \u0275\u0275textInterpolate2(" ", ctx_r0.formatTime(active_r3.startTime), "\u2013", ctx_r0.formatTime(active_r3.endTime), " ");
    \u0275\u0275advance(4);
    \u0275\u0275textInterpolate1("\u0410\u0443\u0434. ", active_r3.room, "");
    \u0275\u0275advance(2);
...
function StudentCheckinComponent_Conditional_7_Conditional_7_Template(rf, ctx) {
  ...
  if (rf & 2) {
    let tmp_4_0;
    const ctx_r0 = \u0275\u0275nextContext(2);
    const nextPlanned_r4 = \u0275\u0275readContextLet(3);
    \u0275\u0275advance(4);
    \u0275\u0275textInterpolate1(" ", (tmp_4_0 = \u0275\u0275pipeBind1(5, 2, ctx_r0.getSubjectName$(nextPlanned_r4.subjectId))) !== null && tmp_4_0 !== void 0 ? tmp_4_0 : "\u041F\u0440\u0435\u0434\u043C\u0435\u0442", " ");
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate1(" \u043D\u0430\u0447\u0430\u043B\u043E \u0432 ", ctx_r0.formatTime(nextPlanned_r4.startTime), " ");
  }
}
...
function StudentCheckinComponent_Conditional_7_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275element(2, "i", 24);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(3, "h2", 25);
    \u0275\u0275text(4, "\u041D\u0435\u0442 \u0430\u043A\u0442\u0438\u0432\u043D\u043E\u0439 \u043F\u0430\u0440\u044B");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(5, "p", 26);
    \u0275\u0275text(6, " \u041E\u0442\u043C\u0435\u0442\u043A\u0430 \u0441\u0442\u0430\u043D\u0435\u0442 \u0434\u043E\u0441\u0442\u0443\u043F\u043D\u0430 \u0437\u0430 5 \u043C\u0438\u043D\u0443\u0442 \u0434\u043E \u043D\u0430\u0447\u0430\u043B\u0430 \u0441\u043B\u0435\u0434\u0443\u044E\u0449\u0435\u0433\u043E \u0437\u0430\u043D\u044F\u0442\u0438\u044F. ");
    \u0275\u0275elementEnd();
    \u0275\u0275template(7, StudentCheckinComponent_Conditional_7_Conditional_7_Template, 8, 4, "div", 27)(8, StudentCheckinComponent_Conditional_7_Conditional_8_Template, 2, 0, "p", 28);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    \u0275\u0275nextContext();
    const nextPlanned_r4 = \u0275\u0275readContextLet(3);
    \u0275\u0275advance(7);
    \u0275\u0275conditional(nextPlanned_r4 ? 7 : 8);
  }
}
...
var StudentCheckinComponent = class _StudentCheckinComponent {
  ...
  ngOnInit() {
    ...
    this.stomp.marked$.pipe(takeUntilDestroyed(this.destroyRef)).subscribe((payload) => {
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(StudentCheckinComponent, { className: "StudentCheckinComponent", filePath: "src/app/features/student/checkin/student-checkin.component.ts", lineNumber: 94 });
})();
export {
  StudentCheckinComponent
};
//# sourceMappingURL=chunk-3TNXW5KE.js.map
