...
> **Status (2026-04-27):** структура только что создана, файлы пока **не перенесены**. Сейчас многое всё ещё лежит на верхнем уровне `docs/`. Этот индекс описывает целевую раскладку — миграция произойдёт позже отдельным PR.
