...
> **Note (2026-04-27 normalization):** v1.0 phase numbering ниже отражает state on day of shipping. Phases originally numbered `1.1-1.4` (sub-phases). Renormalized в `1-4` 2026-04-27 ради единой сквозной нумерации с v2.0+. Канонический snapshot для v1.0 — `.planning/milestones/v1.0-ROADMAP.md` (обновлён). Эта запись остаётся как историческое отражение момента релиза v2.0.
