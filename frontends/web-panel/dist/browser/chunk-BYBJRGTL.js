...
function StudentDashboardComponent_Conditional_17_Conditional_7_For_2_Template(rf, ctx) {
  if (rf & 1) {
...
function StudentDashboardComponent_Conditional_17_Conditional_7_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275repeaterCreate(1, StudentDashboardComponent_Conditional_17_Conditional_7_For_2_Template, 7, 9, "div", 21, _forTrack0);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
...
function StudentDashboardComponent_Conditional_17_Conditional_8_For_8_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275element(0, "app-redzone-warning", 28);
  }
  if (rf & 2) {
...
function StudentDashboardComponent_Conditional_17_Conditional_8_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "section", 20)(1, "div", 16)(2, "h3", 17);
    \u0275\u0275text(3, "\u0412\u043D\u0438\u043C\u0430\u043D\u0438\u0435 \u043A \u043F\u043E\u0441\u0435\u0449\u0430\u0435\u043C\u043E\u0441\u0442\u0438");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(4, "p", 26);
    \u0275\u0275text(5, "\u041F\u0440\u0435\u0434\u043C\u0435\u0442\u044B \u043D\u0438\u0436\u0435 \u043F\u043E\u0440\u043E\u0433\u0430 \u043F\u043E\u0441\u0435\u0449\u0430\u0435\u043C\u043E\u0441\u0442\u0438");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(6, "div", 27);
    \u0275\u0275repeaterCreate(7, StudentDashboardComponent_Conditional_17_Conditional_8_For_8_Template, 1, 2, "app-redzone-warning", 28, _forTrack1);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    const ctx_r0 = \u0275\u0275nextContext(2);
...
function StudentDashboardComponent_Conditional_17_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275pipe(1, "async");
    \u0275\u0275elementStart(2, "section", 15)(3, "div", 16)(4, "h3", 17);
    \u0275\u0275text(5, "\u0420\u0430\u0441\u043F\u0438\u0441\u0430\u043D\u0438\u0435 \u043D\u0430 \u0441\u0435\u0433\u043E\u0434\u043D\u044F");
    \u0275\u0275elementEnd()();
    \u0275\u0275template(6, StudentDashboardComponent_Conditional_17_Conditional_6_Template, 2, 0, "p", 18)(7, StudentDashboardComponent_Conditional_17_Conditional_7_Template, 3, 0, "div", 19);
    \u0275\u0275elementEnd();
    \u0275\u0275template(8, StudentDashboardComponent_Conditional_17_Conditional_8_Template, 9, 0, "section", 20);
  }
  if (rf & 2) {
    let tmp_2_0;
    const ctx_r0 = \u0275\u0275nextContext();
    ...
    \u0275\u0275advance(6);
    \u0275\u0275conditional(ctx_r0.todaySorted().length === 0 ? 6 : 7);
    \u0275\u0275advance(2);
    \u0275\u0275conditional(ctx_r0.redZoneSubjects().length > 0 ? 8 : -1);
  }
}
...
var StudentDashboardComponent = class _StudentDashboardComponent {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _StudentDashboardComponent, selectors: [["app-student-dashboard"]], decls: 18, vars: 5, consts: [[1, "student-dashboard"], [1, "page-hero"], [1, "page-hero__body"], [1, "page-hero__eyebrow"], ["aria-hidden", "true", 1, "page-hero__pulse"], [1, "page-hero__title"], [1, "page-hero__subtitle"], ["aria-hidden", "true", 1, "page-hero__aside"], [1, "page-hero__aside-value"], [1, "page-hero__aside-label"], ["role", "alert", 1, "dashboard-error"], ["aria-busy", "true", "aria-label", "\u0417\u0430\u0433\u0440\u0443\u0437\u043A\u0430\u2026", 1, "dashboard-skeleton-row"], ["aria-hidden", "true", 1, "ph", "ph-warning-circle"], [1, "dashboard-skeleton"], [3, "lesson", "subjectName"], [1, "dashboard-today"], [1, "section-head"], [1, "section-head__title"], [1, "dashboard-today__empty"], [1, "dashboard-today__row"], [1, "dashboard-redzone"], [1, "dashboard-today-chip", 3, "dashboard-today-chip--active", "dashboard-today-chip--cancelled"], [1, "dashboard-today-chip"], [1, "dashboard-today-chip__time"], ["aria-hidden", "true", 1, "dashboard-today-chip__dot"], [1, "dashboard-today-chip__name"], [1, "section-head__sub"], [1, "dashboard-redzone__list"], [3, "subjectName", "percentage"]], template: function StudentDashboardComponent_Template(rf, ctx) {
    if (rf & 1) {
      ...
      \u0275\u0275text(14, "\u043F\u043E \u041C\u043E\u0441\u043A\u0432\u0435");
      \u0275\u0275elementEnd()()();
      \u0275\u0275template(15, StudentDashboardComponent_Conditional_15_Template, 3, 1, "div", 10)(16, StudentDashboardComponent_Conditional_16_Template, 3, 0, "div", 11)(17, StudentDashboardComponent_Conditional_17_Template, 9, 6);
      \u0275\u0275elementEnd();
    }
    if (rf & 2) {
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(StudentDashboardComponent, [{
    ...
    ], template: `<section class="student-dashboard" [@routeFade]>
  ...
  @if (error()) {
    ...
    <div class="dashboard-skeleton-row" aria-busy="true" aria-label="\u0417\u0430\u0433\u0440\u0443\u0437\u043A\u0430\u2026">
    ...
    <section class="dashboard-today">
      <div class="section-head">
        <h3 class="section-head__title">\u0420\u0430\u0441\u043F\u0438\u0441\u0430\u043D\u0438\u0435 \u043D\u0430 \u0441\u0435\u0433\u043E\u0434\u043D\u044F</h3>
      </div>
    ...
    @if (redZoneSubjects().length > 0) {
      <section class="dashboard-redzone">
        <div class="section-head">
          <h3 class="section-head__title">\u0412\u043D\u0438\u043C\u0430\u043D\u0438\u0435 \u043A \u043F\u043E\u0441\u0435\u0449\u0430\u0435\u043C\u043E\u0441\u0442\u0438</h3>
          <p class="section-head__sub">\u041F\u0440\u0435\u0434\u043C\u0435\u0442\u044B \u043D\u0438\u0436\u0435 \u043F\u043E\u0440\u043E\u0433\u0430 \u043F\u043E\u0441\u0435\u0449\u0430\u0435\u043C\u043E\u0441\u0442\u0438</p>
        </div>
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(StudentDashboardComponent, { className: "StudentDashboardComponent", filePath: "src/app/features/student/dashboard/student-dashboard.component.ts", lineNumber: 79 });
})();
export {
  StudentDashboardComponent
};
//# sourceMappingURL=chunk-BYBJRGTL.js.map
