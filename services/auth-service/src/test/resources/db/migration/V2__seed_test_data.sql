...
VALUES
    ('admin',   '$2a$10$A9r8miSBxjlpjxFB/z0jIerCCSOrLQP6N.sXrjBAw9l7iy4vmRFpi', 'Admin',   'Test', NULL, 'admin',   'active', false, NULL),
    ('teacher', '$2a$10$A9r8miSBxjlpjxFB/z0jIerCCSOrLQP6N.sXrjBAw9l7iy4vmRFpi', 'Teacher', 'Test', NULL, 'teacher', 'active', false, NULL),
    ('student', '$2a$10$A9r8miSBxjlpjxFB/z0jIerCCSOrLQP6N.sXrjBAw9l7iy4vmRFpi', 'Student', 'Test', NULL, 'student', 'active', true,  1);
