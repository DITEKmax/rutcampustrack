...
function SidebarComponent_Conditional_5_For_2_Conditional_4_Template(rf, ctx) {
  if (rf & 1) {
...
function SidebarComponent_Conditional_5_For_2_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "li")(1, "a", 16, 0);
    \u0275\u0275element(3, "i", 17);
    \u0275\u0275template(4, SidebarComponent_Conditional_5_For_2_Conditional_4_Template, 2, 1, "span", 13);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    const item_r1 = ctx.$implicit;
    const rlaPrimary_r2 = \u0275\u0275reference(2);
    const ctx_r2 = \u0275\u0275nextContext(2);
    \u0275\u0275advance();
    \u0275\u0275property("routerLink", item_r1.route)("title", item_r1.label);
    \u0275\u0275attribute("aria-current", rlaPrimary_r2.isActive ? "page" : null)("aria-label", ctx_r2.collapsed() ? item_r1.label : null);
    \u0275\u0275advance(2);
    \u0275\u0275classMap(item_r1.icon);
    \u0275\u0275advance();
    \u0275\u0275conditional(!ctx_r2.collapsed() ? 4 : -1);
  }
}
function SidebarComponent_Conditional_5_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "ul", 7);
    \u0275\u0275repeaterCreate(1, SidebarComponent_Conditional_5_For_2_Template, 5, 7, "li", null, _forTrack02);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r2 = \u0275\u0275nextContext();
    \u0275\u0275advance();
    \u0275\u0275repeater(ctx_r2.filteredPrimaryItems());
  }
}
function SidebarComponent_Conditional_6_Conditional_0_Template(rf, ctx) {
  ...
  if (rf & 2) {
    const ctx_r2 = \u0275\u0275nextContext(2);
    \u0275\u0275advance();
    \u0275\u0275textInterpolate(ctx_r2.sectionLabel());
  }
}
...
function SidebarComponent_Conditional_6_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275template(0, SidebarComponent_Conditional_6_Conditional_0_Template, 2, 1, "p", 18)(1, SidebarComponent_Conditional_6_Conditional_1_Template, 1, 0, "div", 19);
  }
  if (rf & 2) {
    const ctx_r2 = \u0275\u0275nextContext();
...
function SidebarComponent_For_9_Conditional_5_Template(rf, ctx) {
  ...
  if (rf & 2) {
    const ctx_r2 = \u0275\u0275nextContext(2);
    \u0275\u0275attribute("aria-label", "\u0423\u0432\u0435\u0434\u043E\u043C\u043B\u0435\u043D\u0438\u044F, " + ctx_r2.unreadCount() + " \u043D\u0435\u043F\u0440\u043E\u0447\u0438\u0442\u0430\u043D\u043D\u044B\u0445");
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" ", ctx_r2.unreadCount() > 9 ? "9+" : ctx_r2.unreadCount(), " ");
  }
}
function SidebarComponent_For_9_Conditional_6_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "span", 13);
    \u0275\u0275text(1);
    \u0275\u0275elementEnd();
...
function SidebarComponent_For_9_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "li")(1, "a", 16, 1)(3, "span", 20);
    \u0275\u0275element(4, "i", 17);
    \u0275\u0275template(5, SidebarComponent_For_9_Conditional_5_Template, 2, 2, "span", 21);
    \u0275\u0275elementEnd();
    \u0275\u0275template(6, SidebarComponent_For_9_Conditional_6_Template, 2, 1, "span", 13);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    const item_r4 = ctx.$implicit;
    const rlaSecondary_r5 = \u0275\u0275reference(2);
    const ctx_r2 = \u0275\u0275nextContext();
    \u0275\u0275advance();
    \u0275\u0275property("routerLink", item_r4.route)("title", item_r4.label);
    \u0275\u0275attribute("aria-current", rlaSecondary_r5.isActive ? "page" : null);
    \u0275\u0275advance(3);
    \u0275\u0275classMap(item_r4.icon);
    \u0275\u0275advance();
    \u0275\u0275conditional(item_r4.icon === "ph-bell" && ctx_r2.unreadCount() > 0 ? 5 : -1);
    \u0275\u0275advance();
    \u0275\u0275conditional(!ctx_r2.collapsed() ? 6 : -1);
  }
}
...
function SidebarComponent_Conditional_10_For_4_Conditional_4_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "span", 13);
    \u0275\u0275text(1);
    \u0275\u0275elementEnd();
...
function SidebarComponent_Conditional_10_For_4_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "li")(1, "a", 16, 2);
    \u0275\u0275element(3, "i", 17);
    \u0275\u0275template(4, SidebarComponent_Conditional_10_For_4_Conditional_4_Template, 2, 1, "span", 13);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    const item_r6 = ctx.$implicit;
    const rlaHeadman_r7 = \u0275\u0275reference(2);
    const ctx_r2 = \u0275\u0275nextContext(2);
    \u0275\u0275advance();
    \u0275\u0275property("routerLink", item_r6.route)("title", item_r6.label);
    \u0275\u0275attribute("aria-current", rlaHeadman_r7.isActive ? "page" : null);
    \u0275\u0275advance(2);
...
function SidebarComponent_Conditional_10_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275template(0, SidebarComponent_Conditional_10_Conditional_0_Template, 2, 0, "p", 18)(1, SidebarComponent_Conditional_10_Conditional_1_Template, 1, 0, "div", 19);
    \u0275\u0275elementStart(2, "ul", 8);
    \u0275\u0275repeaterCreate(3, SidebarComponent_Conditional_10_For_4_Template, 5, 6, "li", null, _forTrack02);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r2 = \u0275\u0275nextContext();
    \u0275\u0275conditional(!ctx_r2.collapsed() ? 0 : 1);
    \u0275\u0275advance(3);
    \u0275\u0275repeater(ctx_r2.filteredHeadmanNavItems());
  }
}
...
function SidebarComponent_Conditional_13_Conditional_0_Case_8_Template(rf, ctx) {
  ...
  if (rf & 2) {
    const user_r9 = \u0275\u0275nextContext(2);
    \u0275\u0275textInterpolate1(" ", user_r9.isHeadman ? "\u0421\u0442\u0430\u0440\u043E\u0441\u0442\u0430" : "\u0421\u0442\u0443\u0434\u0435\u043D\u0442", " ");
  }
}
function SidebarComponent_Conditional_13_Conditional_0_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    let tmp_6_0;
    let tmp_7_0;
    const user_r9 = \u0275\u0275nextContext();
    const ctx_r2 = \u0275\u0275nextContext();
    \u0275\u0275advance();
    \u0275\u0275property("avatarId", (tmp_3_0 = ctx_r2.profile()) == null ? null : tmp_3_0.avatarId)("initials", ctx_r2.profileInitials() || "?")("size", 36);
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate(ctx_r2.profileDisplayName() || ((tmp_6_0 = ctx_r2.profile()) == null ? null : tmp_6_0.login) || "\u2014");
    \u0275\u0275advance(2);
    \u0275\u0275conditional((tmp_7_0 = user_r9.role) === "ADMIN" ? 6 : tmp_7_0 === "TEACHER" ? 7 : tmp_7_0 === "STUDENT" ? 8 : -1);
  }
}
function SidebarComponent_Conditional_13_Conditional_1_Template(rf, ctx) {
  ...
  if (rf & 2) {
    let tmp_4_0;
    const ctx_r2 = \u0275\u0275nextContext(2);
    \u0275\u0275property("title", ctx_r2.profileDisplayName() || "\u041F\u0440\u043E\u0444\u0438\u043B\u044C");
    \u0275\u0275advance();
    \u0275\u0275property("avatarId", (tmp_4_0 = ctx_r2.profile()) == null ? null : tmp_4_0.avatarId)("initials", ctx_r2.profileInitials() || "?")("size", 36);
  }
}
function SidebarComponent_Conditional_13_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275template(0, SidebarComponent_Conditional_13_Conditional_0_Template, 9, 5, "button", 22)(1, SidebarComponent_Conditional_13_Conditional_1_Template, 2, 4, "button", 23);
  }
  if (rf & 2) {
    const ctx_r2 = \u0275\u0275nextContext();
    \u0275\u0275conditional(!ctx_r2.collapsed() ? 0 : 1);
...
var SidebarComponent = class _SidebarComponent {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _SidebarComponent, selectors: [["app-sidebar"]], decls: 20, vars: 14, consts: [["rlaPrimary", "routerLinkActive"], ["rlaSecondary", "routerLinkActive"], ["rlaHeadman", "routerLinkActive"], ["aria-label", "\u041E\u0441\u043D\u043E\u0432\u043D\u0430\u044F \u043D\u0430\u0432\u0438\u0433\u0430\u0446\u0438\u044F", 1, "sidebar"], ["routerLink", "/", "aria-label", "RutCampusTrack \u2014 \u0433\u043B\u0430\u0432\u043D\u0430\u044F", 1, "sidebar__brand"], ["aria-hidden", "true", 1, "sidebar__brand-mark"], [1, "sidebar__brand-name"], [1, "sidebar__nav", "sidebar__nav--primary"], [1, "sidebar__nav"], [1, "sidebar__spacer"], [1, "sidebar__footer"], ["type", "button", "title", "\u0412\u044B\u0439\u0442\u0438", 1, "sidebar__footer-btn", 3, "click"], ["aria-hidden", "true", 1, "ph", "ph-sign-out", "sidebar__icon"], [1, "sidebar__label"], ["type", "button", 1, "sidebar__footer-btn", "sidebar__collapse-btn", 3, "click", "title"], ["aria-hidden", "true", 1, "ph", "ph-caret-left", "sidebar__icon"], ["routerLinkActive", "sidebar__link--active", 1, "sidebar__link", 3, "routerLink", "title"], ["aria-hidden", "true", 1, "ph", "sidebar__icon"], [1, "sidebar__section"], ["aria-hidden", "true", 1, "sidebar__section-divider"], [1, "sidebar__icon-wrap", 2, "position", "relative", "display", "inline-flex"], [1, "notification-badge"], ["type", "button", "aria-label", "\u041E\u0442\u043A\u0440\u044B\u0442\u044C \u043F\u0440\u043E\u0444\u0438\u043B\u044C", 1, "sidebar__user", "sidebar__user--button"], ["type", "button", "aria-label", "\u041E\u0442\u043A\u0440\u044B\u0442\u044C \u043F\u0440\u043E\u0444\u0438\u043B\u044C", 1, "sidebar__user", "sidebar__user--collapsed", "sidebar__user--button", 3, "title"], ["type", "button", "aria-label", "\u041E\u0442\u043A\u0440\u044B\u0442\u044C \u043F\u0440\u043E\u0444\u0438\u043B\u044C", 1, "sidebar__user", "sidebar__user--button", 3, "click"], [3, "avatarId", "initials", "size"], [1, "sidebar__user-meta"], [1, "sidebar__user-name"], [1, "sidebar__user-role"], ["type", "button", "aria-label", "\u041E\u0442\u043A\u0440\u044B\u0442\u044C \u043F\u0440\u043E\u0444\u0438\u043B\u044C", 1, "sidebar__user", "sidebar__user--collapsed", "sidebar__user--button", 3, "click", "title"]], template: function SidebarComponent_Template(rf, ctx) {
    if (rf & 1) {
      ...
      \u0275\u0275element(15, "i", 12);
      \u0275\u0275template(16, SidebarComponent_Conditional_16_Template, 2, 0, "span", 13);
      \u0275\u0275elementEnd();
      ...
      \u0275\u0275element(18, "i", 15);
      \u0275\u0275template(19, SidebarComponent_Conditional_19_Template, 2, 0, "span", 13);
      \u0275\u0275elementEnd()()();
    }
    if (rf & 2) {
      let tmp_7_0;
      ...
      @for (item of filteredPrimaryItems(); track item.route) {\r
        <li>\r
          <a\r
            ...
            #rlaPrimary="routerLinkActive"\r
            [attr.aria-current]="rlaPrimary.isActive ? 'page' : null"\r
    ...
    @for (item of filteredNavItems(); track item.route) {\r
      <li>\r
        <a\r
          [routerLink]="item.route"\r
          routerLinkActive="sidebar__link--active"\r
          #rlaSecondary="routerLinkActive"\r
          [attr.aria-current]="rlaSecondary.isActive ? 'page' : null"\r
          class="sidebar__link"\r
          [title]="item.label"\r
        >\r
      ...
      @for (item of filteredHeadmanNavItems(); track item.route) {\r
        <li>\r
          <a\r
            [routerLink]="item.route"\r
            routerLinkActive="sidebar__link--active"\r
            #rlaHeadman="routerLinkActive"\r
            [attr.aria-current]="rlaHeadman.isActive ? 'page' : null"\r
            class="sidebar__link"\r
            [title]="item.label"\r
          >\r
            <i [class]="item.icon" class="ph sidebar__icon" aria-hidden="true"></i>\r
...
function NotificationBellComponent_Conditional_4_Conditional_4_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(1, " \u041E\u0442\u043C\u0435\u0442\u0438\u0442\u044C \u0432\u0441\u0435 \u043F\u0440\u043E\u0447\u0438\u0442\u0430\u043D\u043D\u044B\u043C\u0438 ");
    \u0275\u0275elementEnd();
  }
}
function NotificationBellComponent_Conditional_4_Conditional_5_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "p", 7);
    \u0275\u0275text(1, "\u041F\u043E\u043A\u0430 \u043D\u0435\u0442 \u0443\u0432\u0435\u0434\u043E\u043C\u043B\u0435\u043D\u0438\u0439.");
    \u0275\u0275elementEnd();
  }
}
function NotificationBellComponent_Conditional_4_Conditional_6_For_2_Template(rf, ctx) {
  if (rf & 1) {
    const _r3 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "li")(1, "button", 11);
    \u0275\u0275listener("click", function NotificationBellComponent_Conditional_4_Conditional_6_For_2_Template_button_click_1_listener() {
      const item_r4 = \u0275\u0275restoreView(_r3).$implicit;
      const ctx_r0 = \u0275\u0275nextContext(3);
      return \u0275\u0275resetView(ctx_r0.openItem(item_r4));
    });
    \u0275\u0275elementStart(2, "div", 12)(3, "strong");
    \u0275\u0275text(4);
    \u0275\u0275elementEnd();
  ...
  if (rf & 2) {
    ...
    const ctx_r0 = \u0275\u0275nextContext(3);
    \u0275\u0275advance();
    \u0275\u0275classProp("is-unread", !item_r4.read);
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate(ctx_r0.heading(item_r4));
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(ctx_r0.relativeTime(item_r4));
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(ctx_r0.body(item_r4));
  }
}
function NotificationBellComponent_Conditional_4_Conditional_6_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "ul", 8);
    \u0275\u0275repeaterCreate(1, NotificationBellComponent_Conditional_4_Conditional_6_For_2_Template, 9, 5, "li", null, _forTrack03);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r0 = \u0275\u0275nextContext(2);
    \u0275\u0275advance();
    \u0275\u0275repeater(ctx_r0.items().slice(0, 15));
  }
}
function NotificationBellComponent_Conditional_4_Conditional_7_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275listener("click", function NotificationBellComponent_Conditional_4_Conditional_7_Template_button_click_1_listener() {
      \u0275\u0275restoreView(_r5);
      const ctx_r0 = \u0275\u0275nextContext(2);
      return \u0275\u0275resetView(ctx_r0.openFullList());
    });
    \u0275\u0275text(2, " \u0412\u0441\u0435 \u0443\u0432\u0435\u0434\u043E\u043C\u043B\u0435\u043D\u0438\u044F ");
    \u0275\u0275elementEnd()();
  }
}
function NotificationBellComponent_Conditional_4_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 4)(1, "div", 5)(2, "span");
    \u0275\u0275text(3, "\u0423\u0432\u0435\u0434\u043E\u043C\u043B\u0435\u043D\u0438\u044F");
    \u0275\u0275elementEnd();
    \u0275\u0275template(4, NotificationBellComponent_Conditional_4_Conditional_4_Template, 2, 0, "button", 6);
    \u0275\u0275elementEnd();
    \u0275\u0275template(5, NotificationBellComponent_Conditional_4_Conditional_5_Template, 2, 0, "p", 7)(6, NotificationBellComponent_Conditional_4_Conditional_6_Template, 3, 0, "ul", 8)(7, NotificationBellComponent_Conditional_4_Conditional_7_Template, 3, 0, "div", 9);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r0 = \u0275\u0275nextContext();
    \u0275\u0275advance(4);
    \u0275\u0275conditional(ctx_r0.unreadCount() > 0 ? 4 : -1);
    \u0275\u0275advance();
    \u0275\u0275conditional(ctx_r0.items().length === 0 ? 5 : 6);
    \u0275\u0275advance(2);
    \u0275\u0275conditional(ctx_r0.items().length > 0 ? 7 : -1);
  }
}
var NotificationBellComponent = class _NotificationBellComponent {
  ...
  unreadCount = this.center.unreadCount;
  open = signal(false);
  isHeadman = computed(() => this.auth.currentUser()?.isHeadman === true);
  toggle() {
  ...
  body(item) {
    ...
    const subjectName = p["subject_name"] ?? "";
    const student = p["student_name"] ?? "";
    const lessonNumber = p["lesson_number"] ?? p["lessonNumber"];
    const lessonDate = p["lesson_date"] ?? "";
    const dateText = lessonDate ? this.formatRuDate(lessonDate) : "";
    const comment = p["decision_comment"] ?? "";
    switch (item.type) {
      case "lesson.started":
        return `${subjectName || "\u041F\u0430\u0440\u0430"} \u043D\u0430\u0447\u0430\u043B\u0430\u0441\u044C \u2014 \u043E\u0442\u043C\u0435\u0442\u044C\u0442\u0435\u0441\u044C.`;
      case "lesson.cancelled":
        return `\u041F\u0430\u0440\u0430${subjectName ? " \xAB" + subjectName + "\xBB" : ""}${dateText ? " " + dateText : ""} \u043E\u0442\u043C\u0435\u043D\u0435\u043D\u0430.`;
      case "homework.published":
        return subjectName ? `\u0417\u0430\u0434\u0430\u043D\u0438\u0435 \u043F\u043E ${subjectName}.` : "\u041E\u043F\u0443\u0431\u043B\u0438\u043A\u043E\u0432\u0430\u043D\u043E \u043D\u043E\u0432\u043E\u0435 \u0437\u0430\u0434\u0430\u043D\u0438\u0435.";
      case "homework.updated":
        return subjectName ? `\u0417\u0430\u0434\u0430\u043D\u0438\u0435 \u043F\u043E ${subjectName} \u043E\u0431\u043D\u043E\u0432\u043B\u0435\u043D\u043E.` : "\u0417\u0430\u0434\u0430\u043D\u0438\u0435 \u043E\u0431\u043D\u043E\u0432\u043B\u0435\u043D\u043E.";
      case "attendance.marked": {
      ...
      case "late_checkin.requested": {
        const n = lessonNumber ? `\u2116${lessonNumber}` : "";
        const subj = subjectName ? ` \xAB${subjectName}\xBB` : "";
  ...
  }, decls: 5, vars: 6, consts: [[1, "nbell"], ["type", "button", 1, "nbell__button", 3, "click"], ["aria-hidden", "true", 1, "ph", "ph-bell"], [1, "nbell__badge"], ["role", "menu", 1, "nbell__panel"], [1, "nbell__panel-head"], ["type", "button", 1, "nbell__link"], [1, "nbell__empty"], [1, "nbell__list"], [1, "nbell__panel-foot"], ["type", "button", 1, "nbell__link", 3, "click"], ["type", "button", 1, "nbell__item", 3, "click"], [1, "nbell__item-head"], [1, "nbell__item-time"], [1, "nbell__item-text"]], template: function NotificationBellComponent_Template(rf, ctx) {
    if (rf & 1) {
      ...
      \u0275\u0275element(2, "i", 2);
      \u0275\u0275template(3, NotificationBellComponent_Conditional_3_Template, 2, 1, "span", 3);
      \u0275\u0275elementEnd();
      \u0275\u0275template(4, NotificationBellComponent_Conditional_4_Template, 8, 3, "div", 4);
      \u0275\u0275elementEnd();
    }
    if (rf & 2) {
      \u0275\u0275classProp("nbell--open", ctx.open());
      \u0275\u0275advance();
      \u0275\u0275attribute("aria-expanded", ctx.open())("aria-label", ctx.unreadCount() > 0 ? "\u0423\u0432\u0435\u0434\u043E\u043C\u043B\u0435\u043D\u0438\u044F, " + ctx.unreadCount() + " \u043D\u0435\u043F\u0440\u043E\u0447\u0438\u0442\u0430\u043D\u043D\u044B\u0445" : "\u0423\u0432\u0435\u0434\u043E\u043C\u043B\u0435\u043D\u0438\u044F");
      \u0275\u0275advance(2);
      \u0275\u0275conditional(ctx.unreadCount() > 0 ? 3 : -1);
      \u0275\u0275advance();
      \u0275\u0275conditional(ctx.open() ? 4 : -1);
    }
  }, dependencies: [CommonModule], styles: ["\n\n.nbell[_ngcontent-%COMP%] {\n  position: relative;\n}\n.nbell__button[_ngcontent-%COMP%] {\n  position: relative;\n  display: inline-flex;\n  align-items: center;\n  justify-content: center;\n  width: 40px;\n  height: 40px;\n  border-radius: var(--radius-full);\n  border: 1px solid var(--border-subtle);\n  background: var(--bg-secondary);\n  color: var(--text-secondary);\n  cursor: pointer;\n  transition: border-color var(--duration-base) var(--ease-out), color var(--duration-base) var(--ease-out);\n}\n.nbell__button[_ngcontent-%COMP%]:hover, \n.nbell--open[_ngcontent-%COMP%]   .nbell__button[_ngcontent-%COMP%] {\n  border-color: var(--border-default);\n  color: var(--text-primary);\n}\n.nbell__button[_ngcontent-%COMP%]   i[_ngcontent-%COMP%] {\n  font-size: 18px;\n}\n.nbell__badge[_ngcontent-%COMP%] {\n  position: absolute;\n  top: -2px;\n  right: -2px;\n  min-width: 18px;\n  height: 18px;\n  padding: 0 5px;\n  border-radius: 9px;\n  background: var(--accent-danger);\n  color: #fff;\n  font: 600 10px/18px var(--font-mono);\n  text-align: center;\n}\n.nbell__panel[_ngcontent-%COMP%] {\n  position: absolute;\n  top: calc(100% + 8px);\n  right: 0;\n  width: 360px;\n  max-height: 480px;\n  display: flex;\n  flex-direction: column;\n  background: var(--bg-surface);\n  border: 1px solid var(--border-default);\n  border-radius: var(--radius-lg);\n  box-shadow: var(--shadow-lg, 0 8px 32px rgba(0, 0, 0, 0.24));\n  z-index: 50;\n  overflow: hidden;\n}\n.nbell__panel-head[_ngcontent-%COMP%], \n.nbell__panel-foot[_ngcontent-%COMP%] {\n  display: flex;\n  justify-content: space-between;\n  align-items: center;\n  padding: var(--space-3) var(--space-4);\n  border-bottom: 1px solid var(--border-subtle);\n  font: 600 0.875rem/1.2 var(--font-heading);\n}\n.nbell__panel-foot[_ngcontent-%COMP%] {\n  border-top: 1px solid var(--border-subtle);\n  border-bottom: none;\n}\n.nbell__link[_ngcontent-%COMP%] {\n  background: none;\n  border: 0;\n  padding: 0;\n  color: var(--accent-primary);\n  font: 500 0.8125rem var(--font-body);\n  cursor: pointer;\n}\n.nbell__link[_ngcontent-%COMP%]:hover {\n  text-decoration: underline;\n}\n.nbell__empty[_ngcontent-%COMP%] {\n  padding: var(--space-5) var(--space-4);\n  text-align: center;\n  color: var(--text-muted);\n  font-size: 0.875rem;\n  margin: 0;\n}\n.nbell__list[_ngcontent-%COMP%] {\n  list-style: none;\n  padding: 0;\n  margin: 0;\n  overflow-y: auto;\n  flex: 1;\n}\n.nbell__item[_ngcontent-%COMP%] {\n  display: block;\n  width: 100%;\n  text-align: left;\n  background: none;\n  border: 0;\n  padding: var(--space-3) var(--space-4);\n  border-bottom: 1px solid var(--border-subtle);\n  border-left: 3px solid transparent;\n  cursor: pointer;\n  transition: background var(--duration-base) var(--ease-out);\n}\n.nbell__item[_ngcontent-%COMP%]:hover {\n  background: var(--bg-secondary);\n}\n.nbell__item.is-unread[_ngcontent-%COMP%] {\n  border-left-color: var(--accent-primary);\n}\n.nbell__item-head[_ngcontent-%COMP%] {\n  display: flex;\n  justify-content: space-between;\n  align-items: baseline;\n  gap: var(--space-2);\n  margin-bottom: 2px;\n}\n.nbell__item-head[_ngcontent-%COMP%]   strong[_ngcontent-%COMP%] {\n  font: 600 0.875rem var(--font-heading);\n  color: var(--text-primary);\n}\n.nbell__item-time[_ngcontent-%COMP%] {\n  font: 500 0.6875rem var(--font-mono);\n  color: var(--text-muted);\n  white-space: nowrap;\n}\n.nbell__item-text[_ngcontent-%COMP%] {\n  margin: 0;\n  font-size: 0.8125rem;\n  color: var(--text-secondary);\n  line-height: 1.4;\n  display: -webkit-box;\n  -webkit-line-clamp: 2;\n  -webkit-box-orient: vertical;\n  overflow: hidden;\n}\n/*# sourceMappingURL=notification-bell.component.css.map */"], changeDetection: 0 });
};
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(NotificationBellComponent, [{
    type: Component,
    args: [{ selector: "app-notification-bell", standalone: true, changeDetection: ChangeDetectionStrategy.OnPush, imports: [CommonModule], template: `
  ...
  `, styles: ["/* angular:styles/component:css;5202af014da168cdc9de6515cb550bae580d8f5735cf874577a05533c36896cc;C:/Users/maksd/IntelliJIDEA/rutcampustrack/frontends/web-panel/src/app/core/notifications/notification-bell.component.ts */\n.nbell {\n  position: relative;\n}\n.nbell__button {\n  position: relative;\n  display: inline-flex;\n  align-items: center;\n  justify-content: center;\n  width: 40px;\n  height: 40px;\n  border-radius: var(--radius-full);\n  border: 1px solid var(--border-subtle);\n  background: var(--bg-secondary);\n  color: var(--text-secondary);\n  cursor: pointer;\n  transition: border-color var(--duration-base) var(--ease-out), color var(--duration-base) var(--ease-out);\n}\n.nbell__button:hover,\n.nbell--open .nbell__button {\n  border-color: var(--border-default);\n  color: var(--text-primary);\n}\n.nbell__button i {\n  font-size: 18px;\n}\n.nbell__badge {\n  position: absolute;\n  top: -2px;\n  right: -2px;\n  min-width: 18px;\n  height: 18px;\n  padding: 0 5px;\n  border-radius: 9px;\n  background: var(--accent-danger);\n  color: #fff;\n  font: 600 10px/18px var(--font-mono);\n  text-align: center;\n}\n.nbell__panel {\n  position: absolute;\n  top: calc(100% + 8px);\n  right: 0;\n  width: 360px;\n  max-height: 480px;\n  display: flex;\n  flex-direction: column;\n  background: var(--bg-surface);\n  border: 1px solid var(--border-default);\n  border-radius: var(--radius-lg);\n  box-shadow: var(--shadow-lg, 0 8px 32px rgba(0, 0, 0, 0.24));\n  z-index: 50;\n  overflow: hidden;\n}\n.nbell__panel-head,\n.nbell__panel-foot {\n  display: flex;\n  justify-content: space-between;\n  align-items: center;\n  padding: var(--space-3) var(--space-4);\n  border-bottom: 1px solid var(--border-subtle);\n  font: 600 0.875rem/1.2 var(--font-heading);\n}\n.nbell__panel-foot {\n  border-top: 1px solid var(--border-subtle);\n  border-bottom: none;\n}\n.nbell__link {\n  background: none;\n  border: 0;\n  padding: 0;\n  color: var(--accent-primary);\n  font: 500 0.8125rem var(--font-body);\n  cursor: pointer;\n}\n.nbell__link:hover {\n  text-decoration: underline;\n}\n.nbell__empty {\n  padding: var(--space-5) var(--space-4);\n  text-align: center;\n  color: var(--text-muted);\n  font-size: 0.875rem;\n  margin: 0;\n}\n.nbell__list {\n  list-style: none;\n  padding: 0;\n  margin: 0;\n  overflow-y: auto;\n  flex: 1;\n}\n.nbell__item {\n  display: block;\n  width: 100%;\n  text-align: left;\n  background: none;\n  border: 0;\n  padding: var(--space-3) var(--space-4);\n  border-bottom: 1px solid var(--border-subtle);\n  border-left: 3px solid transparent;\n  cursor: pointer;\n  transition: background var(--duration-base) var(--ease-out);\n}\n.nbell__item:hover {\n  background: var(--bg-secondary);\n}\n.nbell__item.is-unread {\n  border-left-color: var(--accent-primary);\n}\n.nbell__item-head {\n  display: flex;\n  justify-content: space-between;\n  align-items: baseline;\n  gap: var(--space-2);\n  margin-bottom: 2px;\n}\n.nbell__item-head strong {\n  font: 600 0.875rem var(--font-heading);\n  color: var(--text-primary);\n}\n.nbell__item-time {\n  font: 500 0.6875rem var(--font-mono);\n  color: var(--text-muted);\n  white-space: nowrap;\n}\n.nbell__item-text {\n  margin: 0;\n  font-size: 0.8125rem;\n  color: var(--text-secondary);\n  line-height: 1.4;\n  display: -webkit-box;\n  -webkit-line-clamp: 2;\n  -webkit-box-orient: vertical;\n  overflow: hidden;\n}\n/*# sourceMappingURL=notification-bell.component.css.map */\n"] }]
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(NotificationBellComponent, { className: "NotificationBellComponent", filePath: "src/app/core/notifications/notification-bell.component.ts", lineNumber: 215 });
})();

// src/app/layout/header/header.component.ts
function HeaderComponent_Conditional_8_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275element(0, "app-notification-bell");
  }
}
function HeaderComponent_Conditional_9_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275listener("click", function HeaderComponent_Conditional_9_Template_button_click_0_listener() {
      \u0275\u0275restoreView(_r1);
      const ctx_r1 = \u0275\u0275nextContext();
...
var HeaderComponent = class _HeaderComponent {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _HeaderComponent, selectors: [["app-header"]], decls: 10, vars: 4, consts: [[1, "shell-header"], [1, "shell-header__title"], [1, "shell-header__eyebrow"], [1, "shell-header__heading"], [1, "shell-header__actions"], ["type", "button", "aria-label", "\u041E\u0442\u043A\u0440\u044B\u0442\u044C \u043F\u0440\u043E\u0444\u0438\u043B\u044C", 1, "user-chip", "user-chip--button"], ["type", "button", "aria-label", "\u041E\u0442\u043A\u0440\u044B\u0442\u044C \u043F\u0440\u043E\u0444\u0438\u043B\u044C", 1, "user-chip", "user-chip--button", 3, "click"], [3, "avatarId", "initials", "size"], [1, "user-chip__meta"], [1, "user-chip__name"]], template: function HeaderComponent_Template(rf, ctx) {
    if (rf & 1) {
      ...
      \u0275\u0275template(8, HeaderComponent_Conditional_8_Template, 1, 0, "app-notification-bell")(9, HeaderComponent_Conditional_9_Template, 7, 7, "button", 5);
      \u0275\u0275elementEnd()();
    }
    if (rf & 2) {
      \u0275\u0275advance(3);
...
var ShellComponent = class _ShellComponent {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _ShellComponent, selectors: [["app-shell"]], decls: 9, vars: 1, consts: [[1, "shell"], [1, "shell__sidebar"], [1, "shell__column"], ["mode", "indeterminate", "aria-label", "\u0417\u0430\u0433\u0440\u0443\u0437\u043A\u0430 \u0441\u0442\u0440\u0430\u043D\u0438\u0446\u044B", 1, "shell__route-progress"], ["tabindex", "-1", 1, "shell__main"], [1, "shell__content"]], template: function ShellComponent_Template(rf, ctx) {
    if (rf & 1) {
      \u0275\u0275elementStart(0, "div", 0);
      \u0275\u0275element(1, "app-sidebar", 1);
      \u0275\u0275elementStart(2, "div", 2);
      \u0275\u0275element(3, "app-header");
      \u0275\u0275template(4, ShellComponent_Conditional_4_Template, 1, 0, "mat-progress-bar", 3);
      \u0275\u0275element(5, "app-student-pwa-banner");
      \u0275\u0275elementStart(6, "main", 4)(7, "div", 5);
      \u0275\u0275element(8, "router-outlet");
      \u0275\u0275elementEnd()()()();
    }
    if (rf & 2) {
      \u0275\u0275advance(4);
      \u0275\u0275conditional(ctx.navigating() ? 4 : -1);
    }
  }, dependencies: [
    RouterOutlet,
    SidebarComponent,
