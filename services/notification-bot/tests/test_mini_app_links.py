...
def test_build_mini_app_url_adds_startapp_for_telegram_deep_link():
    assert (
        ...
        == "https://t.me/ruttrack_bot/ruttrack?startapp=checkin%3A101"
    )
...
def test_build_mini_app_url_adds_tg_start_param_for_direct_web_app_url():
    assert (
        ...
        == "https://ruttrack.site/mini-app/?tgWebAppStartParam=checkin%3A101"
    )
...
def test_build_mini_app_button_uses_url_for_telegram_deep_link():
    ...
    assert button.url == "https://t.me/ruttrack_bot/ruttrack?startapp=checkin%3A7"
...
def test_build_mini_app_button_uses_web_app_for_direct_url():
    ...
    assert button.web_app.url == "https://ruttrack.site/mini-app/?tgWebAppStartParam=checkin%3A7"
