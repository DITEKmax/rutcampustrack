...
- [x] **MARK-01**: Headman can manually set attendance status for any student in their group
- [x] **MARK-02**: Manual marking works per student (autosave per click, not batch)
...
- [x] **RPRT-01**: Headman/teacher can view lesson attendance (all students + their status for a lesson)
- [x] **RPRT-02**: Headman/teacher can view journal (students x lesson dates grid for group+subject)
- [x] **RPRT-03**: Student can view own attendance stats (% per subject, excluding cancelled)
- [x] **RPRT-04**: Student can view own attendance list (raw records, filterable by subject)
...
| RPRT-01 | Phase 18 | Complete |
| RPRT-02 | Phase 18 | Complete |
| RPRT-03 | Phase 18 | Complete |
| RPRT-04 | Phase 18 | Complete |
