...
/**
 * M02 Группа 8 — академический аналог schedule.EventSchemaValidator.
 * Из academic-service вверх на 3 уровня до event-schemas/.
 */
public final class EventSchemaValidator {
    ...
    public static Path schemasDir() {
        return Path.of("").toAbsolutePath()
                .getParent()   // services/academic-service
                .getParent()   // services
                .getParent()   // repo root
