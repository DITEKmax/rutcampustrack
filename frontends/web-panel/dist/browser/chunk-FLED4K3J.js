  ...
  onRestore(lesson) {
    this.dialog.open(ConfirmDialogComponent, {
      data: {
        ...
        message: `\u041F\u0430\u0440\u0430 \xAB${this.subjectName(lesson.subjectId)}\xBB \u0441\u043D\u043E\u0432\u0430 \u043F\u043E\u044F\u0432\u0438\u0442\u0441\u044F \u0432 \u0440\u0430\u0441\u043F\u0438\u0441\u0430\u043D\u0438\u0438 \u0438 \u0431\u0443\u0434\u0435\u0442 \u0443\u0447\u0438\u0442\u044B\u0432\u0430\u0442\u044C\u0441\u044F \u0432 \u0441\u0442\u0430\u0442\u0438\u0441\u0442\u0438\u043A\u0435.`,
...
(() => {
  ...
  `, styles: ["/* angular:styles/component:css;3b225c0396e0929ecf2ab4314c2cf894838b52dfb6b3f36da613e8b38ec286dd;C:/Users/maksd/IntelliJIDEA/rutcampustrack/frontends/web-panel/src/app/features/headman/lessons/headman-lessons.component.ts */\n.day-card {\n  padding: 16px;\n}\n.day-heading {\n  font-size: 1rem;\n  font-weight: 600;\n  margin: 0 0 12px;\n  color: var(--text-primary);\n}\n.lesson-list {\n  list-style: none;\n  padding: 0;\n  margin: 0;\n  display: flex;\n  flex-direction: column;\n  gap: 8px;\n}\n.lesson-row {\n  display: grid;\n  grid-template-columns: 110px 1fr auto;\n  gap: var(--space-3);\n  align-items: center;\n  padding: var(--space-3) var(--space-4);\n  border: 1px solid var(--border-subtle);\n  border-radius: var(--radius-md);\n  background: var(--bg-surface);\n  transition: border-color var(--duration-base) var(--ease-out), background-color var(--duration-base) var(--ease-out);\n}\n.lesson-row:hover {\n  background: var(--bg-elevated);\n  border-color: var(--border-default);\n}\n.lesson-row--cancelled {\n  opacity: 0.55;\n}\n.lesson-row__time {\n  display: flex;\n  flex-direction: column;\n  gap: 2px;\n}\n.lesson-num {\n  font-family: var(--font-mono);\n  font-size: 0.6875rem;\n  letter-spacing: 0.04em;\n  text-transform: uppercase;\n  color: var(--text-muted);\n}\n.lesson-time {\n  font-family: var(--font-mono);\n  font-variant-numeric: tabular-nums;\n  font-size: 0.875rem;\n  color: var(--text-primary);\n}\n.lesson-subject {\n  font-weight: 600;\n  color: var(--text-primary);\n}\n.lesson-type {\n  font-weight: 500;\n  color: var(--text-muted);\n  margin-left: 4px;\n  font-size: 0.875rem;\n}\n.lesson-meta {\n  display: flex;\n  gap: var(--space-2);\n  align-items: center;\n  flex-wrap: wrap;\n  font-size: 0.8125rem;\n  color: var(--text-secondary);\n  margin-top: 2px;\n}\n.status {\n  display: inline-flex;\n  align-items: center;\n  gap: 6px;\n  padding: 4px 10px;\n  border-radius: var(--radius-full);\n  font: 500 0.6875rem/1 var(--font-mono);\n  letter-spacing: 0.04em;\n  text-transform: uppercase;\n  white-space: nowrap;\n}\n.status--planned {\n  background: color-mix(in oklab, var(--accent-secondary) 14%, transparent);\n  color: var(--accent-secondary);\n  border: 1px solid color-mix(in oklab, var(--accent-secondary) 30%, transparent);\n}\n.status--active {\n  background: color-mix(in oklab, var(--accent-primary) 14%, transparent);\n  color: var(--accent-primary);\n  border: 1px solid color-mix(in oklab, var(--accent-primary) 30%, transparent);\n}\n.status--closed {\n  background: color-mix(in oklab, var(--text-muted) 14%, transparent);\n  color: var(--text-secondary);\n  border: 1px solid color-mix(in oklab, var(--text-muted) 26%, transparent);\n}\n.status--cancelled {\n  background: color-mix(in oklab, var(--accent-danger) 14%, transparent);\n  color: var(--accent-danger);\n  border: 1px solid color-mix(in oklab, var(--accent-danger) 30%, transparent);\n}\n.cancel-reason {\n  font-style: italic;\n}\n.btn-stroke {\n  padding: 6px 14px;\n  border-radius: var(--radius-md);\n  border: 1px solid var(--border-default);\n  background: transparent;\n  color: var(--text-primary);\n  cursor: pointer;\n  font-size: 0.8125rem;\n  font-family: inherit;\n  display: inline-flex;\n  align-items: center;\n  gap: 4px;\n  transition: background-color var(--duration-base) var(--ease-out), border-color var(--duration-base) var(--ease-out);\n}\n.btn-stroke:hover:not([disabled]) {\n  background: var(--bg-elevated);\n  border-color: var(--border-accent);\n}\n.btn-stroke[disabled] {\n  opacity: 0.5;\n  cursor: not-allowed;\n}\n.btn-stroke--danger {\n  color: var(--accent-danger);\n  border-color: color-mix(in oklab, var(--accent-danger) 35%, transparent);\n}\n.btn-stroke--danger:hover:not([disabled]) {\n  background: color-mix(in oklab, var(--accent-danger) 12%, transparent);\n  border-color: color-mix(in oklab, var(--accent-danger) 50%, transparent);\n}\n/*# sourceMappingURL=headman-lessons.component.css.map */\n"] }]
  }], null, null);
})();
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(HeadmanLessonsComponent, { className: "HeadmanLessonsComponent", filePath: "src/app/features/headman/lessons/headman-lessons.component.ts", lineNumber: 248 });
})();
export {
  HeadmanLessonsComponent
};
//# sourceMappingURL=chunk-FLED4K3J.js.map
